{
  ...
  options+:
    {
      ...
      withUseZabbixValueMapping(value=true): {
        options+: {
          useZabbixValueMapping: value,
        },
      },
    },
  withProxy(value): {
  ...
  '#withQueryType': { 'function': { args: [{ default: null, enums: ['0', '1', '2', '3', '4', '5', '6'], name: 'value', type: ['string'] }], help: '' } },
  withQueryType(value): {
    queryType: value,
  },
